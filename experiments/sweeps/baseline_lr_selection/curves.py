...
OUT = ROOT / "experiments/sweeps/baseline_lr_selection/results"
...
def main() -> None:
    ...
    plot_grid(selection, ["lr3e-4", "lr1e-4"], "selection-nll-vs-updates.png", "Baseline LR selection: nine-cell NLL")
    plot_grid(selected, ["lr3e-4"], "selected-nll-vs-updates.png", "Selected baseline continuation: nine-cell NLL")
    ...
    ax.set_title("Selected baseline continuation: refinement relative to (1,0)")
    ax.grid(alpha=0.25)
