# Baseline selection and continuation protocol

Historical record of the completed experiment. This protocol combines a small learning-rate selection sweep with one selected continuation; it is not a generic long-run category. Paths below follow the current repository layout; recorded configurations, measurements, and raw artifact provenance retain their original meaning. See the experiment README for current commands.
