...
STEPS = [750, 1000]
RUNS = {
    'A': ('experiments/sweeps/baseline_lr_selection/configs/lr3e4.py', 'experiments/sweeps/baseline_lr_selection/results/lr3e-4'),
    'B': ('experiments/sweeps/baseline_lr_selection/configs/lr1e4.py', 'experiments/sweeps/baseline_lr_selection/results/lr1e-4'),
}
...
def main():
    panel_path = ROOT / 'experiments/sweeps/baseline_lr_selection/results/panels.json'
    ...
    output = ROOT / 'experiments/sweeps/baseline_lr_selection/results/selection.json'
    if output.exists():
