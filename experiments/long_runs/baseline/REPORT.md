...
Status: complete on 2026-09-18. This report covers only the authorized long-baseline protocol: two 1,000-update learning-rate candidates and one selected continuation to 10,000 total updates. No extra seeds, sweep points, objectives, architecture changes, or cloud resources were used.
