...
FILES = [
    ...
    'experiments/long_runs/baseline/configs/lr3e4.py', 'experiments/long_runs/baseline/configs/lr1e4.py',
    ...
    'experiments/long_runs/baseline/PLAN.md', 'experiments/long_runs/baseline/HANDOFF.md',
...
def main():
    output = ROOT / 'experiments/long_runs/baseline/results/preflight'
